...
kr1 = QHAL.LINE()
kr1.login(token="EpUKFMPOOJlkWb59xXQ5.x71w2igoRqWv9dRC14Wbfq.JxvQOESme48LPwSyxnNYYdqeM1sCPqqiX1drYQkEUNg=")
kr1.loginResult()

kr2 = QHAL.LINE()
kr2.login(token="EpB7PKMOPLlNZ3eZOgCa.cjE4t/gnfzRp7OAc4vRm/G.wu5C8lW21t+TyySz8eeb/FWcZa7aCKeadC0fJ+QQkSI=")
kr2.loginResult()

kr3 = QHAL.LINE()
kr3.login(token="EphEGiYtyiltUrMJxDe6.oO2x7E9CjPERs0QnXEatfG.RjLJlpCiobhguNIWV5RON8vwM85LX7UbPw6uOqewkI4=")
kr3.loginResult()
...
#==============================================================================#
            ...
            elif ".setvid: " in msg.text:
                if msg.from_ in admin:
                    wait['pap'] = msg.text.replace(".setvid: ","")
                    kr1.sendText(msg.to,"Video Has Ben Set To")
            elif msg.text in [".papvid",".Papvid"]:
                if msg.from_ in admin:
...
#==============================================================================#
                ...
                if msg.from_ in admin:
                    kr1.sendText(msg.to,"Aku")
                    kr2.sendText(msg.to,"Adalah")
                    kr3.sendText(msg.to,"Satria Baja Hitam")
                    kr1.sendText(msg.to,"Yekan.....")
...
#==============================================================================#
            ...
            elif msg.text in [".bot come"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
                if msg.from_ in owner:
                    gid = kr1.getGroupIdsJoined()
                ...
                if msg.from_ in admin:
                    if wait["blacklist"] == {}:
                        ...
                        for i in wait["blacklist"]:
                            ...
                            kr1.sendMessage(M)
            elif msg.text in [".midban",".Midban"]:
                if msg.from_ in admin:
                    if msg.toType == 2:
                        group = kr1.getGroup(msg.to)
...
#--------------------------------------------------------
                ...
                if msg.from_ in owner:
                    gName = msg.text.replace(".syn megs ","")
                ...
                if msg.from_ in owner:
                    kr1.sendText(msg.to,"Aku masih aktif Say...!!!")
#===============================================
        if op.type == 17:
            if op.param2 not in Bots:
